...
\begin{figure*}
  ...
  \subfloat[halo 27 DM shape at small
    radius]{\includegraphics[width=0.5\textwidth]{./pics/MHD_Vs_DM/level4_DM_halo_27_inner.png}} 
  \hfill
  \subfloat[halo 27 DM shape at big
    radius]{\includegraphics[width=0.5\textwidth]{./pics/MHD_Vs_DM/level4_DM_halo_27_outter.png}} 
  \hfill 
...
Weak constraint on prolate halo. SDSS stars dynamics.\\\hline  
...
Mid-axis orientation on the outside. \\\hline
...
Mid-axis orientation. Sagittarius stream\\\hline 
...
change between radial regimes.\\\hline  

\citet{Loebman_et_al._2012}&${1.00}$&${0.47}$&$\sim
20$kpc &$0^{\circ}$&Method: SDSS statistics\\\hline 

\cite{Johnston_et_al._2005}&${1}$&$0.83-0.92$&$\lesssim
60$kpc&$0^{\circ}$&Method: Sagittarius stream\\\hline 

\citet{Bovy_et_el._2016}&${0.95}$&${0.95}$&$\lesssim
20$kpc&$90^{\circ}$ & Stellar streams\\\hline 
...
Reference&$q_{\rho}$&$s_{\rho}$&$q_{\phi}$&$s_{\phi}$&$R$& Methodology
\\ \hline \hline
\citet{Chua_et_al._2018}&${0.88\pm0.10}$&${0.70\pm0.11}$&&&$0.15R_{200}$& Illustris\\\hline
...
\multirow{2}{*}{\citet{Abadi_et_al._2010}}&&&${0.98}$&${0.85}$&-&
Almost independent of radius. No feedback: boundary case\\\hline 
\end{tabular}
\caption{(TODO: compute analogues in isopotential or isodensity
  according to Binney and Tremaine) {\bf Al final estos numeros son
    isodensidad o isopotencial}}
\end{table*}



To compare our results against observational values have we to
translate first the isodensity into the corresponding isopotential
rations, in which observational constraints are usually presented.
For this purpose, we run a simple algorithm to find an
...
As a consistency check we compare the isopotential results with the analytic expectation of the
...
$q_{\rho}$. 
Although this analytic expression if meant to be used on the outer
...
We repeat this process for the different radii from table
