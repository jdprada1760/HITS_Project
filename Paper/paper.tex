...
We quantify this effect by plotting the axial ratios $b/a$, $c/a$,
$c/b$ and the triaxiality $T\equiv \frac{1-b/a}{1-c/a}$ as a
function of radius. 
As a representative sample of this relations we show on figure
\ref{fig:triaxial_radius} the radial trends for an specific halo at
the highest resolution both for DM and MHD simulations.
The continouse lines corresponds to the DM simulation and shows how
the inner part of the halo $r\approx 1$\kpch has values of 
$b/a=0.5$, $c/a=0.5$ while at the virial radius the same
quantities increase to $b/a=0.9$, $c/a=0.6$; in turn the triaxiality
decrease from $T\approx 1.0$\kpch to $T\approx=0.4$. 
