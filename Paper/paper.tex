...
the MHD simulations. 
The main radial trend continues to hold, albet less pronounced; halos
...
This situation is summarized Table \ref{table:shape}
We summarize these resulta in Table \ref{table:shape}
