...
average.
This average behaviour is more clear in the individual case of Halo 16
in Figure \ref{fig:triaxial_ratios}. There, as we mentioned, at the virial radius the halo is
rounder than its DM counterpart. 
Going from $50$\kpch to
$10$ \kpch radii the $b/a$ ratio is constant almost close to unity
while it decreases to $0.5$ in DM-only simulation


the DM halo is almost perfectly
...
we summarize these results for the median values of the axis ratio in
